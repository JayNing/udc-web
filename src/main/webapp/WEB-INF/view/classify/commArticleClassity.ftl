...
<@secondaryPerCenter.modelHead title="分类管理-社区文章类型 " >

</@secondaryPerCenter.modelHead>
<link href="${basePath}/resources/css/classify/commArticleClassity.css" rel="stylesheet" type="text/css">
            ...
            <table>
                ...
                <tbody>
                    <tr ng-repeat="x in articles">
                        ...
                        <td ng-cloak class="ng-cloak">{{x.essayTypeName}}</td>
                        <td>
                            <div class="books-btn">
                                <a href="javascript:;" ng-click="edit(x.essayTypeId)">编辑</a>
                                <a href="javascript:;"  ng-click="del(x.essayTypeId,$index)">删除</a>
                            </div>
                        </td>
                    </tr>
                </tbody>
...
<script src="${basePath}/resources/js/classify/commArticleClassity.js" type="text/javascript"></script>
