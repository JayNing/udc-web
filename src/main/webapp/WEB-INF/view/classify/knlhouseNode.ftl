...
<@secondaryPerCenter.modelHead title="分类管理-知识库流程节点类型 " >

</@secondaryPerCenter.modelHead>
<link href="${basePath}/resources/css/classify/knlhouseNode.css" rel="stylesheet" type="text/css">
        ...
        <table>
            ...
            <tbody>
                <tr ng-repeat="x in departments">
                    ...
                    <td ng-cloak class="ng-cloak">{{x.flowName}}</td>
                    <td>
                        <div class="books-btn">
                            <a href="javascript:;"  ng-click="edit(x.flowId)">编辑</a>
                            <a href="javascript:;"  ng-click="del(x.flowId,$index)">删除</a>
                        </div>
                    </td>
                </tr>
...
<script src="${basePath}/resources/js/classify/knlhouseNode.js" type="text/javascript"></script>
