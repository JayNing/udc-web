...
<@defaultLayout.htmlHead title="知识仓库-分类-PDF " keywords="UDC知识库管理平台" description ="UDC知识库管理平台">

</@defaultLayout.htmlHead>
<link href="${basePath}/resources/css/knlwarehouse/knseClassifyPDF.css" rel="stylesheet" type="text/css">
...
<div class="main warehouse-article-detail clearfix">
    ...
    <div class="warehouse-content warehouse-article" ng-controller="pdfController">
        ...
        <p class="pdf-brief" ng-bind="brief"></p>
        <div class="warehouse-file"><img src="${basePath}/resources/images/knlwarehouse/pdf.jpg" /></div>
...
<script src="${basePath}/resources/js/knlwarehouse/knseClassifyPDF.js" type="text/javascript"></script>
</@defaultLayout.js_scripts>
