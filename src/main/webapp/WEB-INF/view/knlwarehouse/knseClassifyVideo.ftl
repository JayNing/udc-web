...
<@defaultLayout.htmlHead title="知识仓库-分类-视频 " keywords="UDC知识库管理平台" description ="UDC知识库管理平台">

</@defaultLayout.htmlHead>
<link href="${basePath}/resources/css/knlwarehouse/knseClassifyVideo.css" rel="stylesheet" type="text/css">
...
<div class="main warehouse-article-detail clearfix">
    ...
    <div class="warehouse-content warehouse-article" ng-controller="videoController">
        ...
        <div class="warehouse-video">
            <video sr="" controls="controls"></video>
        </div>
...
<script src="${basePath}/resources/js/knlwarehouse/knseClassifyVideo.js" type="text/javascript"></script>
</@defaultLayout.js_scripts>
