...
<@secondaryPerCenter.modelHead title="会员中心 -帖子列表" >

</@secondaryPerCenter.modelHead>
<link href="${basePath}/resources/css/member/postList.css" rel="stylesheet" type="text/css">
...
<script src="${basePath}/resources/js/member/postList.js" type="text/javascript"></script>
