...
<link href="${basePath}/resources/css/resourceManager/searchResult.css" rel="stylesheet" type="text/css">
...
<script src="${basePath}/resources/js/resourceManager/searchResult.js" type="text/javascript"></script>
</@resourceManage.js_scripts>
